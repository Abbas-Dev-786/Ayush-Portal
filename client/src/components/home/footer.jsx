  ...
  return (
    ...
    >
      <Box>
        ...
        <Box sx={{ fontSize: "0.9rem" }} ml={4} mb={2.5}>
          <ul>
            <li>
              <a href="">Login</a>
            </li>
        ...
        <Typography sx={{ fontSize: "0.6rem" }} lineHeight={0.5} ml={1}>
          Feedback
        </Typography>
        <Typography sx={{ fontSize: "0.6rem" }} ml={1}>
          Copyright Ministery of Ayush. All Rights Reserved{" "}
        </Typography>
      ...
      <Box>
        ...
        <Box sx={{ fontSize: "1.5rem" }} mb={2.5} ml={5} mt={3}>
          <ul className="ul">
            <li>
